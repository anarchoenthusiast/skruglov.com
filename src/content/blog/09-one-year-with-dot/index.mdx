...
// Импортируем только растровые изображения для оптимизации
// import heroPhoto from '../../../assets/blog/wwdc23/hero-photo.jpg';
...
{/* SVG иллюстрации остаются в public/ - оптимально для векторной графики */}
...
{/* Растровые фотографии должны использовать assets/ для оптимизации */}
{/* <Image src={heroPhoto} alt="Real photo from Apple Park" quality={80} /> */}

<figure>
  ![Apple Park interior design](/blog/wwdc23/apple-park-interior.svg)
  <figcaption>The stunning interior of Apple Park during WWDC</figcaption>
</figure>
...
<figure>
  ![Vision Pro experience video demonstration](/blog/wwdc23/vision-pro-experience.svg)
  <figcaption>Interactive demonstration of Vision Pro spatial computing capabilities</figcaption>
</figure>

<figure>
  ![Vision Pro demonstration at WWDC](/blog/wwdc23/vision-pro-demo.svg)
  <figcaption>First hands-on experience with Apple Vision Pro</figcaption>
</figure>
